...
public class Day10Test {
    ...
    public void testDeelTwee_1() {
        String result = target.deelTweeA(INPUT_DEEL2_1, null);
    ...
    public void testDeelTwee_2() {
        String result = target.deelTweeA(INPUT_DEEL2_2, null);
    ...
    public void testDeelTwee_3() {
        String result = target.deelTweeA(INPUT_DEEL2_3, null);
    ...
    public void testDeelTwee_4() {
        String result = target.deelTweeA(INPUT_DEEL2_4, null);
